...
describe('normalize', () => {
  ...
  describe('transform', () => {
    it('normalizes the path according to rootDir', () => {
      ...
      expect(config.transform[0][1]).toEqual(expectedPathFooBar);
      expect(config.transform[1][1]).toEqual(expectedPathFooQux);
    });
    ...
    it('does not change absolute paths', () => {
      ...
      expect(config.transform[0][1]).toEqual(expectedPathAbs);
      expect(config.transform[1][1]).toEqual(expectedPathAbs);
    });
